...
- **Static UI (`public/`)**:
  - `public/index.html` - **Primary Full-Screen Interactive World Map Viewport** (Hero Guild HUD with HP/MP bars, pan/zoom, state matching, Mana Ember particle canvas, `📜` FAB Quest Scroll, slide-out Quest Tome drawer).
  ...
  - `public/dashboard.html` - Member login & site management dashboard ("Hero Keep") with optional State selection for site creation and updates.
